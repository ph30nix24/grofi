...
export const cardsData: CreditCardItem[] = [
  ...
  },
  {
    id: "amex-platinum",
    imgSrc: '',
    name: "Platinum Card (Metal)",
    bank: "American Express",
    category: "luxury",
    badge: "Iconic Global Prestige",
    annualFee: "₹60,000 + GST",
    rewardRate: "Membership Rewards with 3X multipliers",
    loungeAccess: "Unlimited Centurion, Delta & Priority Pass Lounges",
    cardType: "Metal",
    keyPerks: [
      "Exclusive Centurion Lounge network access globally",
      "Elite tier status across Marriott, Hilton & Radisson hotels",
      "₹45,000+ luxury vouchers including Taj, Postcard & dining",
    ],
    welcomeBenefit: "135,000 Membership Rewards points or Taj stay vouchers",
    cardTheme: {
      bgStyle: "bg-gradient-to-br from-[#d9d9d9] via-[#bfbfbf] to-[#8c8c8c]",
      borderStyle: "border-gray-400 shadow-gray-500/20",
      textColor: "text-gray-900",
      chipColor: "bg-[#e5c158]",
      network: "AMEX",
      artElement: "centurion",
    },
    applyLink: "#apply-amex-plat",
  },
  {
    id: "icici-emeralde",
  ...
  },
  {
    ...
    bank: "American Express",
    category: "rewards",
    badge: "Classic 24K Gold Multiplier",
    annualFee: "₹4,500 + GST",
    rewardRate: "5X points on Reward Multiplier",
    loungeAccess: "Special lounge access privileges",
    cardType: "Metal",
    keyPerks: [
      "1,000 bonus Membership Rewards points every month on 6 spends of ₹1,000+",
      "5X reward points on Apple, Flipkart, MakeMyTrip via Reward Multiplier",
      "Redeem points from the prestigious 18K & 24K Gold Collection catalogue",
    ],
    welcomeBenefit: "4,000 Membership Rewards points on first card spend",
    cardTheme: {
      bgStyle: "bg-gradient-to-br from-[#eab308] via-[#ca8a04] to-[#a16207]",
      borderStyle: "border-amber-300/50 shadow-amber-900/30",
      textColor: "text-amber-950",
      chipColor: "bg-[#fef08a]",
      network: "AMEX",
      artElement: "gold-leaf",
    },
    applyLink: "#apply-amex-gold",
  },
  {
    id: "yes-marquee",

...
export default function Hero2() {
  ...
  return (
    <div className="flex flex-col min-h-screen font-montserrat bg-linear-to-br from-[#F3F0DF] via-[#ECE9CF] to-[#DDE3C1]">
      ...
      <section className="relative flex-1 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div
            className="absolute -bottom-10 -left-15 w-56 h-56 rounded-full border-20 border-[#C9AA3C]/15"
          />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-8 flex flex-wrap xl:flex-nowrap items-center gap-4 pt-8 pb-0 relative">
          ...
          <div className="w-full xl:w-[38%] shrink-0 flex flex-col gap-4 pb-8 z-10 reveal-slide-left">
            ...
            <div className="w-14 h-0.75 bg-gold rounded-full" />

            <p className="text-sm text-black/60 leading-relaxed max-w-75">
        ...
        {/* ── Stats strip ──────────────────────────────────────────────── */}
        <div className="max-w-7xl mx-auto px-8 pb-5 relative z-10 reveal-on-scroll delay-150">
      ...
      <div className="relative bg-primary/6 border-t border-primary/10 overflow-hidden py-5 reveal-on-scroll delay-100">
        ...
        <div className="relative overflow-hidden">
          {/* Left fade */}
          <div className="absolute left-0 top-0 h-full w-24 bg-linear-to-r from-[#eef5f5] to-transparent z-10 pointer-events-none" />
          {/* Right fade */}
          <div className="absolute right-0 top-0 h-full w-24 bg-linear-to-l from-[#eef5f5] to-transparent z-10 pointer-events-none" />
